...
_Auto-generated weekly by `.github/workflows/traffic-snapshot.yml`. Last updated: 2026-09-21._

**Report skills.sh installs as the headline install number** (it is all-time and CLI-specific).

| Metric | Value | Source | Notes |
|---|---|---|---|
| **skills.sh installs (all-time)** | **2.5K** | skills.sh CLI | scraped 2026-09-21; the cleanest install number |
